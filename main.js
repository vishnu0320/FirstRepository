...
function shift(id) {
  ...
  if ((i == manOnBoat1 || i == manOnBoat2) && posOfBoat == 260) {
    //boat to left move
    ...
    if (i == manOnBoat1) manOnBoat1 = 0;
    else manOnBoat2 = 0;
  } else if (
    (i == manOnBoat1 || i == manOnBoat2) &&
    posOfBoat == 640 &&
    count > 0
  ) {
    //boat to right
    ...
    //right to boat move on position 1
    i.style.left = '640px';
    count++;
    manOnBoat1 = i;
  } else if (
    ...
    //right to boat move on position 2
    i.style.left = '690px';
    count++;
    manOnBoat2 = i;
  } else if (
...
function gameover(pos) {
  ...
  let noOfGod = 0;
  if (pos == 261) {
    //left to right boatmove check left side
    if (posOfMan6 < 211) noOfEvil++;
    if (posOfMan5 < 211) noOfEvil++;
    if (posOfMan4 < 211) noOfEvil++;
    if (posOfMan3 < 211) noOfGod++;
    if (posOfMan2 < 211) noOfGod++;
    if (posOfMan1 < 211) noOfGod++;
  } else if (pos == 639) {
    //right to left boatmove check right side

    if (posOfMan6 > 690) noOfEvil++;
    if (posOfMan5 > 690) noOfEvil++;
    if (posOfMan4 > 690) noOfEvil++;
    if (posOfMan3 > 690) noOfGod++;
    if (posOfMan2 > 690) noOfGod++;
    if (posOfMan1 > 690) noOfGod++;
  } else if (pos == 260) {
    if (posOfMan6 <= 310) noOfEvil++;
    if (posOfMan5 <= 310) noOfEvil++;
    if (posOfMan4 <= 310) noOfEvil++;
    if (posOfMan3 <= 310) noOfGod++;
    if (posOfMan2 <= 310) noOfGod++;
    if (posOfMan1 <= 310) noOfGod++;
  } else if (pos == 640) {
    if (posOfMan6 >= 640) noOfEvil++;
    if (posOfMan5 >= 640) noOfEvil++;
    if (posOfMan4 >= 640) noOfEvil++;
    if (posOfMan3 >= 640) noOfGod++;
    if (posOfMan2 >= 640) noOfGod++;
    if (posOfMan1 >= 640) noOfGod++;
